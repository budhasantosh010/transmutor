# V837ap — Global Coordinate or Nonlinear Causal State

## Final diagnosis

`DECODABLE_LOW_DIMENSIONAL_STATE_NOT_CAUSALLY_CLOSED`
...
- Powered families: 4
- Discovery family geometries: 0
- META-confirmed families: 0
- Discovery-final frozen families: 0
- Held-out family passes: 0
- Cross-organism validated families: none
...
`V837aq_PROGRAM_LEVEL_CAUSAL_OPERATOR_LOCALIZATION`
